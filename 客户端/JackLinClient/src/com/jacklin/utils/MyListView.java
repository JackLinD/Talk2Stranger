...
public class MyListView extends ListView implements OnScrollListener {
	...
	private OnRefreshListener1 refreshListener;
	...
	private void changeHeaderViewByState() {
		...
		case DONE:
			...
			lvHeaderProgressBar.setVisibility(View.GONE);
			lvHeaderArrowIv.clearAnimation();
//			lvHeaderArrowIv.setImageResource(R.drawable.default_photo);
			lvHeaderTipsTv.setText("下拉刷新");
			lvHeaderLastUpdatedTv.setVisibility(View.VISIBLE);
			break;
		}
	...
	public void setonRefreshListener1(OnRefreshListener1 refreshListener) {
		this.refreshListener = refreshListener;
		isRefreshable = true;
	}

	public interface OnRefreshListener1 {
