...
public class RegisterServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		String user_phone = reqJson
				.optString(Constants.Register.RequestParams.USER_PHONE);
		String name = reqJson.optString(Constants.Register.RequestParams.NAME);
		String gender = reqJson
				.optString(Constants.Register.RequestParams.GENDER);
		String password = reqJson
				.optString(Constants.Register.RequestParams.PASSWORD);
		String photo = reqJson
				.optString(Constants.Register.RequestParams.PHOTO);

		String game = reqJson.optString(Constants.Register.RequestParams.GAME);
		...
		// 参数缺失
		if (user_phone.isEmpty() || name.isEmpty() || gender.isEmpty()
				|| password.isEmpty() || game.isEmpty() || answer.isEmpty()) {
			logger.error("参数缺失");
