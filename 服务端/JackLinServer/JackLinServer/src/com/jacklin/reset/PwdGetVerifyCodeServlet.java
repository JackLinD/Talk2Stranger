...
import com.jacklin.code.VerifyCodeUtils;
...
public class PwdGetVerifyCodeServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	static Logger logger = Logger.getLogger(PwdGetVerifyCodeServlet.class);
