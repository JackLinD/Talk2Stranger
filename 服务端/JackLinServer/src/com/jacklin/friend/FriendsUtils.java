...
public class FriendsUtils {
	...
	public static JSONObject GetFriends(String user_phone) {
		...
		for (int i = 0; i < friendList.size(); i++) {
			...
			friendInfo.add(0, friend.getUser_phone());
			friendInfo.add(1, friend.getName());
			friendInfo.add(2, friend.getGender());
			friendInfo.add(3, friend.getPhoto());
			friendInfo.add(4, friend.getGame());
			friendInfo.add(5, friend.getTip());
			friendInfo.add(6, friend.getAnswer());
			friendInfo.add(7, friend.getBirthday());
			friendInfo.add(8, friend.getBook());
			friendInfo.add(9, friend.getFilm());
			friendInfo.add(10, friend.getCompany_school());
			friendInfo.add(11, friend.getMood());
	...
	public static JSONObject SearchFriend(String friend_phone) {
		...
		respJson.element(Constants.SearchFriend.ResponeParams.FILM,
				friend.getFilm());
		respJson.element(Constants.SearchFriend.ResponeParams.COMPANY_SCHOOL,
